        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="flex flex-col md:flex-row items-center mb-4 md:mb-0">
              <p className="text-gray-600 dark:text-gray-400 text-sm mb-2 md:mb-0 md:mr-6">
                © 2025 Music Drama Radio. All rights reserved.
              </p>
              <p className="text-gray-500 dark:text-gray-500 text-xs mb-2 md:mb-0 md:mr-6">
                Made by Mini Muuu
              </p>
